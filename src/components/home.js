    ...
    <div class="carousel-item active position-relative">
      ...
      <div class="h-100 card-promo d-flex flex-column justify-content-center align-items-center gap-2">
        ...
        <div class="card-promo-container-bottom">
          ...
          <h4 class="subtitle-promotion text-center">SERVICIO A DOMICILIO</h4>
          <h4
            class="title-promotion-important text-center border border-2 border-danger border-start-0 border-end-0 text-shadow-red text-white">
            24
            HRS</h4>
        </div>
      </div>
